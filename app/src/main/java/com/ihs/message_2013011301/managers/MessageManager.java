...
import com.ihs.message_2013011301.managers.HSMessageChangeListener.HSMessageChangeType;
import com.ihs.message_2013011301.managers.HSMessageManager.QueryResult;
import com.ihs.message_2013011301.managers.HSMessageManager.SendMessageCallback;
import com.ihs.message_2013011301.managers.MessageDBManager.MessageDBOperationResult;
import com.ihs.message_2013011301.types.Constants;
import com.ihs.message_2013011301.types.HSBaseMessage;
import com.ihs.message_2013011301.types.HSBaseMessage.HSMessageStatus;
...
import com.ihs.message_2013011301.types.IMediaProtocol;
import com.ihs.message_2013011301.types.MessageFactory;
...
public class MessageManager implements INotificationObserver {
    ...
    public MessageManager() {
        ...
        HSKeepCenter.getInstance().addListener(new HSKeepCenterListener() {
            ...
            public void onKeepCenterReceivedMessage(HSKeepCenterMessage message) {
                HSLog.e(TAG, "listener received new message_2013011301." + message.getBody());
                if (TextUtils.equals(message.getCommand(), HSKeepCenterMessage.COMMNAND_INSTACT) && TextUtils.equals(message.getActType(), "TYPING-START")) {
                    ...
                    if (components.length == 2) {
                        ...
                        HSLog.d(TAG, "Online message_2013011301 received from: " + components[0]);
                    }
    ...
    public QueryResult queryMessages(String relatedTo, int count, long cursor) {
        ...
        HSLog.d(TAG, "list message_2013011301: " + list);
...
//                                    realMessages.add(new HSUnknownMessage(msg, msg.getTypeString(), Integer.toString(version)));
    ...
    void pullMessages() {
        HSLog.d(TAG, "pull message_2013011301");
