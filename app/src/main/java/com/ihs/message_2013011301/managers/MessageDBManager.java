...
import com.ihs.message_2013011301.types.HSBaseMessage.HSMessageMediaStatus;
...
public class MessageDBManager extends SQLiteOpenHelper {
    ...
    public MessageInsertResult insertMessages(List<HSBaseMessage> messages) {
        ...
        try {
            ...
            for (HSBaseMessage msg : messages) {
                HSLog.d(TAG, "insert message_2013011301 with content " + msg);
                ...
                if (!isMessageExisted) {
                    ...
                    HSLog.d(TAG, "insert message_2013011301 result: " + r);
    ...
    public HSBaseMessage updateMessageMediaStatus(String msgID, int mediaStatus) {
        ...
        if (msg == null) {
            ...
            HSLog.d(TAG, "update message_2013011301 media status " + (result > 0 ? "succeeded" : "failed"));
